export enum messages {
    ...
    ERR_CAN_NOT_SET_EXCLUDE_PUBLICATION_TO_EMPTY_OBJECT = "The subplebbit has subplebbit.settings.challenges[x].exclude[y].publication is set to an empty object. You should either choose which publication to exclude or remove exclude.publication",
