...
| resolveAuthorAddresses | `boolean`  or `undefined` | `true` | Optionaly disable resolving blockchain domain author addresses, which can be done lazily later to save time |
