...
declare const shouldExcludeChallengeSuccess: (subplebbitChallenge: NonNullable<SubplebbitSettings["challenges"]>[0], challengeResults: (Challenge | ChallengeResult)[]) => boolean;
