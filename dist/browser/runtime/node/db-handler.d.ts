...
export declare class DbHandler {
    ...
    createCommentsTable(tableName: string): Promise<void>;
    createVotesTable(tableName: string): Promise<void>;
    createAuthorsTable(tableName: string): Promise<void>;
    createChallengesTable(tableName: string): Promise<void>;
    createSignersTable(tableName: string): Promise<void>;
    createEditsTable(tableName: string): Promise<void>;
    createTablesIfNeeded(): Promise<void>;
    copyTable(srcTable: string, dstTable: string): Promise<void>;
