...
export declare function findCommentInPages(pageIpfs: RepliesPagesTypeIpfs | PostsPagesTypeIpfs, targetCommentCid: string): PageIpfs["comments"][0] | undefined;
export declare function findCommentInPagesRecrusively(pages: RepliesPagesTypeIpfs | PostsPagesTypeIpfs, targetCid: string, targetDepth: number | undefined, visited?: Set<string>): PageIpfs["comments"][0] | undefined;
export {};
