...
function signPublication(publication, signer) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    return [4 /*yield*/, (0, util_1.getKeyPairFromPrivateKeyPem)(signer.privateKey, "")];
                case 1:
                    keyPair = _b.sent();
...
function verifyPublication(publication) {
    return __awaiter(this, void 0, void 0, function () {
        var verifyAuthor, verifyPublicationSignature, _a, publicationJson, originalSignatureObj, editedSignatureObj, _b,
            e_1;
        var _this = this;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    verifyAuthor = function (signature, author) {
                    ...
                    verifyPublicationSignature = function (signature, publicationToBeVerified) {
                        return __awaiter(_this, void 0, void 0, function () {
