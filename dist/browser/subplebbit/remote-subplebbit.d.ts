...
export declare class RemoteSubplebbit extends TypedEmitter<SubplebbitEvents> implements Omit<Partial<SubplebbitIpfsType>, "posts"> {
    ...
    protected _toJSONIpfsBaseNoPosts(): Pick<this, "address" | "signature" | "flairs" | "protocolVersion" | "lastCommentCid" | "title" | "updatedAt" | "challenges" | "description" | "encryption" | "createdAt" | "statsCid" | "pubsubTopic" | "postUpdates" | "roles" | "rules" | "lastPostCid" | "features" | "suggested">;
