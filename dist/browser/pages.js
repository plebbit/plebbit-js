...
var debug = (0, debug_1.default)("plebbit-js:pages");
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        verifyComment = function (comment, parentComment) {
                                ...
                                return __generator(this, function (_b) {
                                    switch (_b.label) {
                                        case 0:
                                            ...
                                            return [4 /*yield*/, (0, signer_1.verifyPublication)(comment)];
                                        case 1:
                                            ...
                                            preloadedCommentsChunks = Object.keys(comment.replies.pages).map(function (sortType) {
                                                return comment.replies.pages[sortType].comments;
                                            });
                                            return [4 /*yield*/, Promise.all(preloadedCommentsChunks.map(function (preloadedComments) {
                                                return __awaiter(_this, void 0, void 0, function () {
                                                    return __generator(this, function (_a) {
                                                        switch (_a.label) {
                                                            case 0:
                                                                return [4 /*yield*/, Promise.all(preloadedComments.map(function (preloadedComment) {
                                                                    return verifyComment(preloadedComment, comment);
                                                                }))];
                                                            case 1:
                        ...
                        return [4 /*yield*/, Promise.all(page.comments.map(function (comment) {
                            return __awaiter(_this, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            // TODO verify signature
                                            return [4 /*yield*/, verifyComment(comment, undefined)];
                                        case 1:
                                            // TODO verify signature
                                            _a.sent();
                                            return [2 /*return*/];
