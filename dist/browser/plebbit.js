...
var Plebbit = /** @class */ (function () {
    function Plebbit(options) {
        ...
        this.ipfsClient = (0, ipfs_http_client_1.create)(this.ipfsHttpClientOptions || this.pubsubHttpClientOptions);
    ...
    Plebbit.prototype.getSubplebbit = function (subplebbitAddress) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        (0, assert_1.default)(subplebbitAddress, "Subplebbit address can't be null");
