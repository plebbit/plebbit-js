    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 5: return [4 /*yield*/, (0, it_all_1.default)(plebbit.ipfsClient.cat(cid))];
                case 6:
                    rawData = _a.sent();
...
exports.sleep = sleep;
function unsubscribeAllPubsubTopics(ipfsClients) {
    return __awaiter(this, void 0, void 0, function () {
        var _this = this;
        return __generator(this, function (_a) {
            return [2 /*return*/, new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                    var errHandle, unsubscribePromises;
                    var _this = this;
                    return __generator(this, function (_a) {
                        ...
                        unsubscribePromises = ipfsClients.map(function (ipfsClient) {
                            return new Promise(function (nestedResolve, nestedReject) { return __awaiter(_this, void 0, void 0, function () {
                                var _this = this;
                                return __generator(this, function (_a) {
                                    ipfsClient.pubsub
                                        .ls()
                                        .then(function (pubsubTopics) { return __awaiter(_this, void 0, void 0, function () {
                                        return __generator(this, function (_a) {
                                            Promise.all(pubsubTopics.map(function (topic) { return ipfsClient.pubsub.unsubscribe(topic); }))
                                                .then(nestedResolve)
                                                .catch(nestedResolve);
                                            return [2 /*return*/];
                                        });
...
function waitTillCommentsUpdate(comments) {
    return __awaiter(this, void 0, void 0, function () {
        var _this = this;
        return __generator(this, function (_a) {
            return [2 /*return*/, new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
