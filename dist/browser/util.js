        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    return [3 /*break*/, 7];
                case 5:
                    return [4 /*yield*/, (0, it_all_1.default)(plebbit.ipfsClient.cat(cid, defaultOptions))];
                case 6:
                    rawData = _a.sent();
            ...
            switch (_a.label) {
                case 0:
                    promises = publications.map(function (publication) {
                        return new Promise(function (publicationResolve, publicationReject) {
                ...
                return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        promises = comments.map(function (comment) {
                            return new Promise(function (commentResolve, commentReject) {
                                return __awaiter(_this, void 0, void 0, function () {
                                    return __generator(this, function (_a) {
                                        switch (_a.label) {
                                            case 0:
