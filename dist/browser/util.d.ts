...
export declare function areEquivalentSubplebbitAddresses(addressA: string, addressB: string): boolean;
export declare function getEquivalentSubplebbitAddresses(address: string): string[];
