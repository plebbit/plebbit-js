...
export declare function setHttpRoutersOnIpfsNodes(ipfsClients: Plebbit["clients"]["ipfsClients"], httpRouterOptions: NonNullable<Plebbit["httpRoutersOptions"]>): Promise<void>;
export declare function hideClassPrivateProps(_this: any): void;
export declare function derivePublicationFromChallengeRequest<T extends DecryptedChallengeRequestMessageType | DecryptedChallengeRequestMessageTypeWithSubplebbitAuthor>(request: T): T extends DecryptedChallengeRequestMessageTypeWithSubplebbitAuthor ? PublicationWithSubplebbitAuthorFromDecryptedChallengeRequest : PublicationFromDecryptedChallengeRequest;
