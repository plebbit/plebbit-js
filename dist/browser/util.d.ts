...
export declare function loadIpfsFileAsJson(cid: any, plebbit: any): Promise<any>;
export declare function loadIpnsAsJson(ipns: any, plebbit: any): Promise<any>;
export declare function sleep(ms: any): Promise<unknown>;
export declare function unsubscribeAllPubsubTopics(ipfsClients: any): Promise<unknown>;
...
export declare function waitTillCommentsUpdate(comments: any): Promise<unknown>;
