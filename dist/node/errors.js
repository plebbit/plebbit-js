...
(function (messages) {
    ...
    messages["ERR_COMMENT_IPFS_SUBPLEBBIT_ADDRESS_MISMATCH"] = "CommentIpfs subplebbitAddress does not match the expected subplebbitAddress";
    ...
    messages["ERR_GET_SUBPLEBBIT_TIMED_OUT"] = "plebbit.getSubplebbit({address}) timed out";
    ...
    messages["ERR_QUOTED_CID_DOES_NOT_EXIST"] = "One or more quoted CIDs do not exist in this subplebbit";
    ...
    messages["ERR_REPLY_LINK_IS_NOT_OF_MEDIA"] = "Publishing a reply to the subplebbit requires a link pointing to media (audio, video, image)";
    messages["ERR_COMMENT_CONTENT_CONTAINS_MARKDOWN_IMAGE"] = "This subplebbit does not allow embedding images in markdown content";
    messages["ERR_COMMENT_CONTENT_CONTAINS_MARKDOWN_VIDEO"] = "This subplebbit does not allow embedding videos in markdown content";
    messages["ERR_COMMENT_HAS_LINK_THAT_IS_IMAGE"] = "This subplebbit does not allow comments with image links";
    messages["ERR_COMMENT_HAS_LINK_THAT_IS_VIDEO"] = "This subplebbit does not allow comments with video links";
    messages["ERR_COMMENT_HAS_SPOILER_ENABLED"] = "This subplebbit does not allow authors to mark comments as spoilers";
    messages["ERR_REPLY_HAS_LINK_THAT_IS_IMAGE"] = "This subplebbit does not allow replies with image links";
    messages["ERR_REPLY_HAS_LINK_THAT_IS_VIDEO"] = "This subplebbit does not allow replies with video links";
    messages["ERR_COMMENT_HAS_LINK_THAT_IS_AUDIO"] = "This subplebbit does not allow comments with audio links";
    messages["ERR_REPLY_HAS_LINK_THAT_IS_AUDIO"] = "This subplebbit does not allow replies with audio links";
    messages["ERR_COMMENT_CONTENT_CONTAINS_MARKDOWN_AUDIO"] = "This subplebbit does not allow embedding audio in markdown content";
    messages["ERR_REPLY_HAS_SPOILER_ENABLED"] = "This subplebbit does not allow authors to mark replies as spoilers";
    messages["ERR_NESTED_REPLIES_NOT_ALLOWED"] = "This subplebbit does not allow nested replies (depth > 1)";
