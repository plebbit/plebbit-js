...
(function (messages) {
    ...
    messages["ERR_FAILED_TO_RESOLVE_IPNS_VIA_IPFS_P2P"] = "Failed to resolve IPNS through IPFS P2P";
    ...
    messages["ERR_VOTE_RECORD_INCLUDES_FIELD_NOT_IN_SIGNED_PROPERTY_NAMES"] = "VotePubsubMessage record includes a field that's not included in signature.signedPropertyNames";
    messages["ERR_COMMENT_EDIT_RECORD_INCLUDES_FIELD_NOT_IN_SIGNED_PROPERTY_NAMES"] = "CommentEditPubsubMessage record includes a field that's not included in signature.signedPropertyNames";
    messages["ERR_COMMENT_PUBSUB_RECORD_INCLUDES_FIELD_NOT_IN_SIGNED_PROPERTY_NAMES"] = "CommentPubsubMessage includes a field that's not included in signature.signedPropertyNames";
    ...
    messages["ERR_REQUEST_PUBLICATION_IS_INVALID_JSON"] = "request.publication is an invalid json after decrypting";
    messages["ERR_REQUEST_PUBLICATION_HAS_INVALID_SCHEMA"] = "request.publication has an invalid schema";
    ...
    messages["ERR_COMMENT_HAS_RESERVED_FIELD"] = "request.publication (Comment) has a reserved field";
    messages["ERR_VOTE_HAS_RESERVED_FIELD"] = "request.publication (Vote) has a reserved field";
    messages["ERR_COMMENT_EDIT_HAS_RESERVED_FIELD"] = "request.publication (CommentEdit) has a reserved field";
