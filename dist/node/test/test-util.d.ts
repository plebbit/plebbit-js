...
export declare function startOnlineSubplebbit(): Promise<import("../subplebbit/rpc-remote-subplebbit.js").RpcRemoteSubplebbit | RemoteSubplebbit | import("../subplebbit/rpc-local-subplebbit.js").RpcLocalSubplebbit | import("../runtime/node/subplebbit/local-subplebbit.js").LocalSubplebbit>;
...
export declare function createSubWithNoChallenge(props: CreateSubplebbitOptions, plebbit: Plebbit): Promise<import("../subplebbit/rpc-remote-subplebbit.js").RpcRemoteSubplebbit | RemoteSubplebbit | import("../subplebbit/rpc-local-subplebbit.js").RpcLocalSubplebbit | import("../runtime/node/subplebbit/local-subplebbit.js").LocalSubplebbit>;
