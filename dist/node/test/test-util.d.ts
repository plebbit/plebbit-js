...
export declare function startOnlineSubplebbit(): Promise<import("../runtime/node/subplebbit/local-subplebbit.js").LocalSubplebbit | import("../subplebbit/rpc-local-subplebbit.js").RpcLocalSubplebbit | import("../subplebbit/rpc-remote-subplebbit.js").RpcRemoteSubplebbit | RemoteSubplebbit>;
...
export declare function createSubWithNoChallenge(props: CreateSubplebbitOptions, plebbit: Plebbit): Promise<import("../runtime/node/subplebbit/local-subplebbit.js").LocalSubplebbit | import("../subplebbit/rpc-local-subplebbit.js").RpcLocalSubplebbit | import("../subplebbit/rpc-remote-subplebbit.js").RpcRemoteSubplebbit | RemoteSubplebbit>;
