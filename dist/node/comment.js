            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        res = _a.sent();
                        if (!res)
                            debug("IPNS (".concat(this.ipnsName, ") is not pointing to any file"));
                        else {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        file = _a.sent();
                        debug("Added comment IPNS to ipfs, cid is ".concat(file.path));
                    ...
                    case 3:
                        _a.sent();
                        debug("Linked comment ipns name(".concat(this.ipnsName, ") to ipfs file (").concat(file.path, ")"));
                        return [3 /*break*/, 5];
                    case 4:
                        e_1 = _a.sent();
