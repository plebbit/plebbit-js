...
var Comment = /** @class */ (function (_super) {
    ...
    Comment.prototype.toJSON = function () {
        return __assign(__assign(__assign({}, this.toJSONIpfs()), this.toJSONCommentUpdate()), {
            cid: this.cid,
            originalContent: this.originalContent
        });
    };
    Comment.prototype.toJSONIpfs = function () {
        return __assign(__assign({}, this.toJSONSkeleton()), {
    ...
    Comment.prototype.toJSONSkeleton = function () {
        return __assign(__assign({}, _super.prototype.toJSONSkeleton.call(this)), {
    ...
    Comment.prototype.toJSONForDb = function (challengeRequestId) {
        ...
        ["replyCount", "upvoteCount", "downvoteCount", "replies", "author"].forEach(function (key) {
    ...
    Comment.prototype.toJSONCommentUpdate = function () {
        ...
        }, (this.originalContent ? {content: this.content} : undefined)), {
...
var CommentEdit = /** @class */ (function (_super) {
    ...
    CommentEdit.prototype.toJSONForDb = function (challengeRequestId) {
        ...
        ["authorAddress", "challengeRequestId", "ipnsKeyName", "signature", "commentCid"].forEach(function (key) {
            return delete json[key];
        });
