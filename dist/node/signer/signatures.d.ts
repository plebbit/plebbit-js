...
import { ChallengeAnswerMessageType, ChallengeMessageType, ChallengeRequestMessageType, ChallengeVerificationMessageType, CommentEditOptionsToSign, CommentEditPubsubMessage, CommentIpfsType, CommentIpfsWithCid, CommentOptionsToSign, CommentPubsubMessage, CommentUpdate, PageIpfs, VoteOptionsToSign, VotePubsubMessage } from "../types.js";
...
export declare function signComment(comment: CommentOptionsToSign, signer: SignerType, plebbit: Plebbit): Promise<JsonSignature>;
export declare function signCommentUpdate(update: Omit<CommentUpdate, "signature">, signer: SignerType): Promise<JsonSignature>;
export declare function signVote(vote: VoteOptionsToSign, signer: SignerType, plebbit: Plebbit): Promise<JsonSignature>;
export declare function signCommentEdit(edit: CommentEditOptionsToSign, signer: SignerType, plebbit: Plebbit): Promise<JsonSignature>;
...
export declare function verifyComment(comment: CommentPubsubMessage | CommentIpfsType, resolveAuthorAddresses: boolean, clientsManager: BaseClientsManager, overrideAuthorAddressIfInvalid: boolean): Promise<({
    valid: true;
} & {
...
export declare function verifyCommentUpdate(update: CommentUpdate, resolveAuthorAddresses: boolean, clientsManager: BaseClientsManager, subplebbitAddress: string, comment: Pick<CommentIpfsWithCid, "signature" | "cid">, overrideAuthorAddressIfInvalid: boolean, resolveDomainSubAddress?: boolean): Promise<ValidationResult>;
