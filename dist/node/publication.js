...
var Publication = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [3 /*break*/, 5];
                    case 1:
                        if (!((msgParsed === null || msgParsed === void 0 ? void 0 : msgParsed.type) === challenge_1.PUBSUB_MESSAGE_TYPES.CHALLENGEVERIFICATION)) return [3 /*break*/, 5];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.subplebbit.plebbit.ipfsClient.pubsub.publish(this.subplebbit.pubsubTopic, (0, from_string_1.fromString)(JSON.stringify(challengeAnswer)))];
                    case 1:
                        _a.sent();
                        debug("Responded to challenge (".concat(challengeAnswer.challengeRequestId, ") with answers"));
                        return [3 /*break*/, 3];
                    case 2:
                        e_1 = _a.sent();
    ...
    Publication.prototype.publish = function (userOptions) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            var options, _b, encryptedPublication, e_2;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        assert_1.default.equal(Boolean((_a = this.subplebbit) === null || _a === void 0 ? void 0 : _a.encryption.publicKey), true, "Failed to load subplebbit for publishing");
                        return [4 /*yield*/, (0, signer_1.encrypt)(JSON.stringify(this), this.subplebbit.encryption.publicKey)];
                    case 2:
                        encryptedPublication = _c.sent();
                        ...
                        return [4 /*yield*/, Promise.all([
                                this.subplebbit.plebbit.ipfsClient.pubsub.publish(this.subplebbit.pubsubTopic, (0, from_string_1.fromString)(JSON.stringify(this.challenge))),
