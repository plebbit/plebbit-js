            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, plebbit.createComment({
                            ...
                            signer: signer,
                            title: "Mock Post - ".concat(postStartTestTime),
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, plebbit.createComment({
                            ...
                            signer: signer,
                            title: "Mock Post - ".concat(postTime),
                            content: "Mock content - ".concat(postTime),
                            subplebbitAddress: subplebbitAddress,
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    _a.label = 3;
                case 3:
                    if (!sortedCommentsPage.nextCid) return [3 /*break*/, 5];
                    return [4 /*yield*/, pagesInstance.getPage(sortedCommentsPage.nextCid)];
                case 4:
                    sortedCommentsPage = _a.sent();
                    sortedComments = sortedComments.concat(sortedCommentsPage.comments);
                    return [3 /*break*/, 3];
                case 5: return [4 /*yield*/, Promise.all(sortedComments.map(function (commentProps) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
