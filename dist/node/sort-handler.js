                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, Promise.all(chunk.map(function (comment) { return __awaiter(_this, void 0, void 0, function () {
                                                var _a, sortedReplies, sortedRepliesCids;
                                                return __generator(this, function (_b) {
                                                    switch (_b.label) {
                                                        case 0: return [4 /*yield*/, this.generatePagesUnderComment(comment)];
                                                        case 1:
    ...
    SortHandler.prototype.generatePagesUnderComment = function (comment, trx) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0: return [4 /*yield*/, Promise.all(this.getSortPromises(comment, trx))];
                    case 1:
                        res = _e.sent();
