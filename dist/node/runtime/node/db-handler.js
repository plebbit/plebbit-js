    ...
    DbHandler.prototype.createCommentsTable = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        return [4 /*yield*/, this.knex.schema.createTable(TABLES.COMMENTS, function (table) {
    ...
    DbHandler.prototype.createVotesTable = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        return [4 /*yield*/, this.knex.schema.createTable(TABLES.VOTES, function (table) {
    ...
    DbHandler.prototype.createAuthorsTable = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        return [4 /*yield*/, this.knex.schema.createTable(TABLES.AUTHORS, function (table) {
    ...
    DbHandler.prototype.createChallengesTable = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        return [4 /*yield*/, this.knex.schema.createTable(TABLES.CHALLENGES, function (table) {
    ...
    DbHandler.prototype.createSignersTable = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        return [4 /*yield*/, this.knex.schema.createTable(TABLES.SIGNERS, function (table) {
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                    return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    return [4 /*yield*/, this.baseTransaction(trx)(TABLES.AUTHORS)
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                    return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    return [4 /*yield*/, this.addAuthorToDbIfNeeded(vote.author, trx)];
                                case 1:
                                    _a.sent();
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 3:
                                    ...
                                    _a.label = 4;
                                case 4:
                                    return [4 /*yield*/, this.queryComment(postOrComment.cid || postOrComment.commentCid, trx)];
                                case 5:
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                    return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    return [4 /*yield*/, this.baseTransaction(trx)(TABLES.CHALLENGES)
                                    ...
                                    return __awaiter(_this, void 0, void 0, function () {
                                        ...
                                        return __generator(this, function (_b) {
                                            switch (_b.label) {
                                                ...
                                                case 1:
                                                    return [2 /*return*/, _a.apply(void 0, [(_b.sent())[0]])];
                                            }
                                        });
                                    });
                                })
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    ...
                                    commentsRows = commentsRows.map(function (props) {
                                        return (0, util_1.replaceXWithY)(props, null, undefined);
                                    }); // Replace null with undefined to save storage (undefined is not included in JSON.stringify)
                                    return [4 /*yield*/, this.baseTransaction(trx)(TABLES.AUTHORS).whereIn("address", commentsRows.map(function (post) {
                                        return post.authorAddress;
                                    }))];
                                case 2:
                                    authors_1 = (_a.sent()).map(function (authorProps) {
                                        return new author_1.default(authorProps);
                                    });
                                    comments = commentsRows.map(function (commentProps) {
                                        var props = __assign(__assign({}, commentProps), {
                                            author: authors_1.filter(function (author) {
                                                return author.address === commentProps.authorAddress;
                                            })[0]
                                        });
                                        if (props["title"])
                                            // @ts-ignore
                            ...
                            switch (_a.label) {
                                ...
                                case 1:
                                    if (!Array.isArray(voteRows))
                                        voteRows = [voteRows];
                                    voteRows = voteRows.map(function (props) {
                                        return (0, util_1.replaceXWithY)(props, null, undefined);
                                    }); // Replace null with undefined to save storage (undefined is not included in JSON.stringify)
                                    return [4 /*yield*/, this.baseTransaction(trx)(TABLES.AUTHORS).whereIn("address", voteRows.map(function (vote) {
                                        return vote.authorAddress;
                                    }))];
                                case 2:
                                    authors_2 = (_a.sent()).map(function (authorProps) {
                                        return new author_1.default(authorProps);
                                    });
                                    votes = voteRows.map(function (voteProps) {
                                        var props = __assign(__assign({}, voteProps), {
                                            author: authors_2.filter(function (author) {
                                                return author.address === voteProps.authorAddress;
                                            })[0]
                                        });
                    ...
                    return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            ...
                            this.baseCommentQuery(trx)
                                ...
                                .then(function (res) {
                                    return _this.createCommentsFromRows.bind(_this)(res, trx);
                                })
                                .then(resolve)
                                .catch(function (err) {
                                    console.error(err);
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                    return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_c) {
                            ...
                            query
                                .then(function (res) {
                                    return resolve(_this.createCommentsFromRows.bind(_this)(res, trx));
                                })
                                .catch(function (err) {
                                    console.error(err);
                                    reject(err);
                    ...
                    return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 2:
                                    voteAuthors = _a.sent();
                                    activeUserAccounts = __spreadArray(__spreadArray([], commentsAuthors, true), voteAuthors, true).map(function (author) {
                        ...
                        return __generator(this, function (_a) {
                            ...
                            this.baseTransaction(trx)(TABLES.COMMENTS)
                                ...
                                .then(function (postCount) {
                                    return resolve(postCount["0"]["count(`cid`)"]);
                                })
                                .catch(reject);
                            return [2 /*return*/];
                        });
...
var subplebbitInitDbIfNeeded = function (subplebbit) {
