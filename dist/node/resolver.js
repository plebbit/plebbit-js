...
export const ethersClients = {};
// TODO Should be rename to domain resolver
async function _resolveViaViem(chainTicker, address, txtRecordName, chainProviderUrl, chainId) {
...
async function _resolveViaSolana(address, txtRecordName, chainProviderUrl) {
...
async function _resolveViaEthers(chainTicker, address, txtRecordName) {
...
export async function resolveTxtRecord(address, txtRecordName, chain, chainProviderUrl, chainId) {
    ...
    if (chainProviderUrl === "ethers.js" && chain === "eth")
        txtRecordResult = await _resolveViaEthers(chain, address, txtRecordName);
    else if (chain === "eth") {
