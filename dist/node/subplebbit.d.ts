...
export declare class Subplebbit extends EventEmitter {
    ...
    defaultProvideCaptcha(challengeRequestMessage: any): Promise<unknown>;
    defaultValidateCaptcha(challengeAnswerMessage: any): Promise<unknown>;
    syncIpnsWithDb(syncIntervalMs: any): Promise<void>;
    start(syncIntervalMs?: number): Promise<void>;
    stopPublishing(): Promise<void>;
    destroy(): Promise<void>;
    _addPublicationToDb(publication: any): Promise<{
        reason: string;
    } | {
        publication: any;
    }>;
